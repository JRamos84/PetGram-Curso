...
export const Logo = (props) => (
  <Link to="/">
    <Svg
      ...
      viewBox="57.3 14 385.4 122"
      {...props}
    >
      <filter id="a">
        <feFlood floodColor="#070602" result="flood" />
        <feMorphology
          in="SourceGraphic"
          operator="dilate"
          radius={2}
          result="outline"
        />
        <feComposite in="flood" in2="outline" operator="in" result="outline2" />
        ...
        <feSpecularLighting
          ...
          surfaceScale={2}
        >
          <fePointLight x={200} y={-1000} z={300} />
        </feSpecularLighting>
        <feComposite
          in="specular"
          in2="SourceGraphic"
